...
class Fd9OneController extends Controller
{
    public function index(){
        ...
        $fd9OneList = Fd9OneForm::where('fd_one_form_id',$ngoListAll->id)->latest()->get();
        CommonController::checkNgotype(1);
        $mainNgoType = CommonController::changeView();

        return view('front.fd9OneForm.index',compact('ngoListAll','fd9OneList'));
    ...
    public function create(){
        ...
        return view('front.fd9OneForm.create',compact('ngoListAll'));
    ...
    public function edit($id){
        ...
        return view('front.fd9OneForm.edit',compact('ngoListAll','fd9OneList'));
    ...
    public function show($id){
        ...
        return view('front.fd9OneForm.show',compact('nVisaEdit','ngoListAll','fd9OneList'));
