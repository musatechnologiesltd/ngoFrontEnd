...
class Fd9Controller extends Controller
{
    ...
    public function index(){
        ...
        $fd9List = Fd9Form::where('fd_one_form_id',$ngoListAll->id)->latest()->get();
        CommonController::checkNgotype(1);
        $mainNgoType = CommonController::changeView();


        return view('front.fdNineForm.index',compact('ngoListAll','fd9List'));
    ...
    public function create(){
        ...
        if($newOldNgo != 'Old'){
           ...
           $ngoStatus = NgoRenew::where('fd_one_form_id',$ngoListAll->id)->first();

        }
        return view('front.fdNineForm.create',compact('ngoListAll','ngoStatus','checkNgoTypeForForeginNgo'));
    ...
    return view('front.fdNineForm.edit',compact('checkNgoTypeForForeginNgo','ngoStatus','fdOneFormData','fdNineData','nVisaId','ngoListAll','countryList','getCityzenshipData'));
    ...
    public function store(Request $request){
        ...
        $fd9FormInfo->fd_one_form_id = $ngoListAll->id;
    ...
    return view('front.fdNineForm.show',compact('checkNgoTypeForForeginNgo','ngoStatus','fdOneFormData','fdNineData','nVisaId','ngoListAll','countryList','getCityzenshipData'));
    ...
    public function mainFd9PdfDownload($id){
        ...
        $checkOldorNew = DB::table('ngo_type_and_languages') ->where('user_id',$ngoListAll->user_id)->value('ngo_type_new_old');
            ...
            ->where('fd_one_form_id',$ngoListAll->id)->first();
