...
class NVisaController extends Controller
{
    public function index(){
        ...
        $nVisaList = NVisa::where('fd_one_form_id',$ngoListAll->id)->latest()->get();
        CommonController::checkNgotype(1);
        $mainNgoType = CommonController::changeView();

    return view('front.nVisa.index',compact('ngoListAll','nVisaList'));
    ...
    return view('front.nVisa.create',compact('fd9Id','ngoListAll','countryList','getCityzenshipData'));
    ...
    public function create(){
        ...
        return view('front.nVisa.create',compact('ngoListAll','countryList','getCityzenshipData'));
    ...
    public function edit($id){
        ...
        return view('front.nVisa.edit',compact('nVisaEdit','ngoListAll','countryList','getCityzenshipData'));
    ...
    public function store(Request $request){
        ...
        if(empty($request->nomination_letter_of_buyer)){
            ...
            $findId = NVisaNecessaryDocumentForWorkPermit::where('n_visa_id',$nVisaId)->value('id');
    ...
    public function update(Request $request,$id){
        ...
        $findIdEmployee = NVisaParticularOfSponsorOrEmployer::where('n_visa_id',$nVisaId)->value('id');
        ...
        $findIdIncumbnet = NVisaParticularsOfForeignIncumbnet::where('n_visa_id',$nVisaId)->value('id');
        ...
        $findIdInfo = NVisaEmploymentInformation::where('n_visa_id',$nVisaId)->value('id');
        ...
        $findIdWork = NVisaWorkPlaceAddress::where('n_visa_id',$nVisaId)->value('id');
        ...
        $findIdAuth = NVisaAuthorizedPersonalOfTheOrg::where('n_visa_id',$nVisaId)->value('id');
        ...
        $findIdCom = NVisaCompensationAndBenifits::where('n_visa_id',$nVisaId)->value('id');
    ...
    public function show($id){
       ...
       ->with(['nVisaParticularOfSponsorOrEmployer','nVisaParticularsOfForeignIncumbnet','nVisaEmploymentInformation','nVisaWorkPlaceAddress','nVisaAuthorizedPersonalOfTheOrg','nVisaNecessaryDocumentForWorkPermit','nVisaManpowerOfTheOffice'])->first();
        ...
        $countryList = Country::orderBy('id','asc')->get();
        $ngoListAll = FdOneForm::where('user_id',Auth::user()->id)->first();
        $ngoStatus = NgoStatus::where('fd_one_form_id',$ngoListAll->id)->first();
        CommonController::checkNgotype(1);
        $mainNgoType = CommonController::changeView();
        $getAllNVisaId = Fd9OneForm::where('id',$nVisaEdit->fd9_one_form_id)->first();

    return view('front.nVisa.show',compact('ngoStatus','nVisaEdit','ngoListAll','countryList','getCityzenshipData'));
    ...
    public function fd9FormExtraPdfDownload($cat,$id){
        ...
        if($cat == 'academic'){
            ...
            $getFileData = Fd9Form::where('id',base64_decode($id))->value('fd9_academic_qualification');
        }elseif($cat == 'technical'){

            $getFileData = Fd9Form::where('id',base64_decode($id))->value('fd9_technical_and_other_qualifications_if_any');

        }elseif($cat == 'pastExperience'){

            $getFileData = Fd9Form::where('id',base64_decode($id))->value('fd9_past_experience');

        }elseif($cat == 'offeredPost'){

            $getFileData = Fd9Form::where('id',base64_decode($id))->value('fd9_offered_post');

        }elseif($cat == 'proposedProject'){

            $getFileData = Fd9Form::where('id',base64_decode($id))->value('fd9_name_of_proposed_project');

        }elseif($cat == 'passportCopy'){

            $getFileData = Fd9Form::where('id',base64_decode($id))->value('fd9_copy_of_passport');
    ...
    public function nVisaDocumentDownload($cat,$id){
        ...
        if($cat == 'nomination'){
            ...
            $getFileData = NVisaNecessaryDocumentForWorkPermit::where('id',$id)->value('nomination_letter_of_buyer');
        }elseif($cat == 'investment'){

            $getFileData = NVisaNecessaryDocumentForWorkPermit::where('id',$id)->value('registration_letter_of_board_of_investment');

        }elseif($cat == 'contract'){

            $getFileData = NVisaNecessaryDocumentForWorkPermit::where('id',$id)->value('employee_contract_copy');

        }elseif($cat == 'directors'){

            $getFileData = NVisaNecessaryDocumentForWorkPermit::where('id',$id)->value('board_of_the_directors_sign_letter');

        }elseif($cat == 'shareHolder'){

            $getFileData = NVisaNecessaryDocumentForWorkPermit::where('id',$id)->value('share_holder_copy');

        }elseif($cat == 'passportCopy'){

            $getFileData = NVisaNecessaryDocumentForWorkPermit::where('id',$id)->value('passport_photocopy');
