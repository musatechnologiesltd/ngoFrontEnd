...
class Fd3FormController extends Controller
{
    ...
    public function edit($id){
        ...
        ;
        return view('front.fd3Form.edit',compact('cityCorporationList','districtList','fd3FormList','divisionList','renewWebsiteName','ngoDurationLastEx','ngoDurationReg','ngo_list_all'));
    ...
    public function store(Request $request){
        ...
        //      'project_approval_exemption_letter_memo_number' => 'required|string',
        //      'project_approval_exemption_letter_date' => 'required|string',
        //      'exemption_amount_in_previous_year' => 'required|string',
        //      'money_received_in_the_previous_year' => 'required|string',
        //      'date_of_payment' => 'required|string',

        //      'type_of_foreign_grant' => 'required|string',
        //      'foreign_grant_amount' => 'required|string',


        //      'local_grant_amount' => 'required|string',
        //      'description_and_price_of_goods' => 'required|string',
        ...
        //      'organization_senior_officer_name_one' => 'required|string',
        //      'organization_senior_officer_designation_one' => 'required|string',
        //      '	organization_senior_officer_name_two' => 'required|string',
        //      'organization_senior_officer_designation_two' => 'required|string',
        ...
        //      'communication_between_NGO_and_donor' => 'required|string',
...
$fd3FormInfo->communication_between_NGO_and_donor =$request->communication_between_NGO_and_donor;
     ...
     public function show($id){
       ...
       return view('front.fd3Form.view',compact('fd2OtherInfo','fd2FormList','cityCorporationList','districtList','fd3FormList','divisionList','renewWebsiteName','ngoDurationLastEx','ngoDurationReg','ngo_list_all'));
