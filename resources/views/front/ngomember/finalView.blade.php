                                                                                    ...
                                                                                    <form method="post" action="{{ route('ngoMember.update',$mainAllDataList->id ) }}" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                                                                ...
                                                                                                <input type="number" data-parsley-required minlength="11" value="{{ $mainAllDataList->member_mobile }}"  maxlength="11" name="phone" class="form-control" id="">
                                                                                            </div>
                                                                                            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
...
@method('DELETE')
                                                ...
                                                <button id="dcmember_id{{ $mainAllDataList->id }}" class="btn btn-success btn-sm" type="button"
