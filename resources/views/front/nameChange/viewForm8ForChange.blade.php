...
<section>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12">
                                    ...
                                    <table class="table table-bordered mt-4 custom_table">
                                       ...
                                       @foreach($formEightList as $key=>$mainAllDataList)
                                        <tr>
                                            <td>{{ $key+1 }}</td>
                                            <td>{{ $mainAllDataList->name }} <br> <span class="text-success">{{ trans('form 8_bn.designation')}}:</span>
                                                {{ $mainAllDataList->desi }}
                                            </td>
                                            <td>

                                                <?php

    $newDate12 = date("d-m-Y", strtotime($mainAllDataList->dob ));
    ...
    @endif
                                            ...
                                            <td><span>{{ trans('form 8_bn.present_address')}}:</span>  {{ $mainAllDataList->present_address }} <br>
                                                <span>{{ trans('form 8_bn.permanent_address')}}:</span>  {{ $mainAllDataList->permanent_address }}
                                            </td>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-sm btn-primary" onclick="location.href = '{{ route('formEightDataEdit',$mainAllDataList->name_slug) }}';"><i
                                                    ...
                                                    <button type="button" onclick="deleteTag({{ $mainAllDataList->id}})" class="btn btn-sm btn-danger"><i
                                                                ...
                                                                <form id="delete-form-{{ $mainAllDataList->id }}" action="{{ route('formEightNgoCommitteMember.destroy',$mainAllDataList->id) }}" method="POST" style="display: none;">
