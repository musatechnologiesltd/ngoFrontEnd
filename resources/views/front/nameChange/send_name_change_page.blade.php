                            ...
                            <div class="card-body">
                                <form method="get" action="{{ route('formEightData') }}" id="form">
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <input type="text" value="{{ $ngoListAll->organization_name }}" name="previous_name" class="form-control" id="" readonly>
                                    </div>

                                    <div class=" mb-3">
                                        <label for="" class="form-label">পুরাতন নাম (বাংলা)</label>
                                        <input type="text" value="{{ $ngoListAll->organization_name_ban }}" name="previous_name_ban" class="form-control" id="" readonly>
                                    </div>
