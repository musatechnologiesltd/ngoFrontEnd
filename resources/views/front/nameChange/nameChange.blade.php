...
$nameChangeList = DB::table('ngo_name_changes')->where('fd_one_form_id',$fdOneFormid->id)->latest()->value('status');
                            ...
                            <div class="no_name_change pt-4">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $allNameChangeListAll->previous_name_ban }}</td>
                                        <td>{{ $allNameChangeListAll->previous_name_eng }}</td>
                                        <td>{{ $allNameChangeListAll->present_name_ban }}</td>
                                        <td>{{ $allNameChangeListAll->present_name_eng }}</td>
                                        <td><span class="text-success">{{ $allNameChangeListAll->status }}</span></td>
                                        <td> <a  href="{{ route('nameChange.view',base64_encode($allNameChangeListAll->id)) }}" class="btn btn-sm btn-outline-success"> <i class="fa fa-eye"></i> </a></td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
