...
<div class="card-body">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><input type="file" accept="pdf/*" name="nomination_letter_of_buyer" class="form-control" id=""></td>
        </tr>
        <tr>
            <td>২</td>
            <td>বিনিয়োগ বোর্ডের নিবন্ধন পত্রের অনুলিপি, যদি আগে জমা না দেওয়া হয়</td>
            <td><input type="file" accept="pdf/*" name="registration_letter_of_board_of_investment" class="form-control" id=""></td>
        </tr>
        <tr>
            <td>৩</td>
            <td>কর্মচারীর ক্ষেত্রে পরিষেবা চুক্তি/চুক্তি/নিয়োগ পত্রের অনুলিপি </td>
            <td><input type="file" accept="pdf/*" name="employee_contract_copy" class="form-control" id=""></td>
        </tr>
        <tr>
            <td>৪</td>
            ...
            <td><input type="file" accept="pdf/*" name="board_of_the_directors_sign_letter" class="form-control" id=""></td>
        </tr>
        <tr>
            <td>৫</td>
            ...
            <td><input type="file" accept="pdf/*" name="share_holder_copy"  class="form-control" id=""></td>
        </tr>
        <tr>
            <td>৬</td>
            <td>কর্মচারীদের জন্য ই-টাইপ ভিসা সহ পাসপোর্টের ফটোকপি/বিনিয়োগকারীদের জন্য পিআই-টাইপ ভিসা</td>
            <td><input type="file" accept="pdf/*" name="passport_photocopy"  class="form-control" id=""></td>
        </tr>
    </table>
</div>
