    ...
    <div class="row">
        <div class="mb-3 col-lg-4">
            ...
            <input type="text" class="form-control" id=""
                   placeholder="প্রতিষ্ঠানের নাম" required name="auth_person_org_name">
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">প্রতিষ্ঠানের বাড়ি নম্বর:<span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="প্রতিষ্ঠানের বাড়ি নম্বর" required name="auth_person_org_house_no">
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">প্রতিষ্ঠানের ফ্ল্যাট নং:  <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="প্রতিষ্ঠানের ফ্ল্যাট নং" required name="auth_person_org_flat_no">
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">প্রতিষ্ঠানের রোড নং: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="প্রতিষ্ঠানের রোড নং" required name="auth_person_org_road_no">
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">প্রতিষ্ঠানের থানা: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
            placeholder="প্রতিষ্ঠানের থানা" required name="auth_person_org_thana">
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">প্রতিষ্ঠানের ডাকঘর:<span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="প্রতিষ্ঠানের ডাকঘর" required name="auth_person_org_post_office">
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">প্রতিষ্ঠানের জেলা:<span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="প্রতিষ্ঠানের জেলা" required name="auth_person_org_district">
        </div>
        <div class="mb-3 col-lg-4">
        ...
        <div class="mb-3 col-lg-4">
            ...
            <input type="text" class="form-control datepicker" id=""
                   placeholder="জমা দেওয়ার তারিখ" required name="submission_date">
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">প্রবাসীর নাম: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="প্রবাসীর নাম" required name="expatriate_name">
        </div>
        <div class="mb-3 col-lg-4">
