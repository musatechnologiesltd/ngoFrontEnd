    ...
    <div class="row">
        ...
        <div class="mb-3 col-lg-4">
            ...
            maxlength = "11" class="form-control" id=""
                   placeholder="প্রতিষ্ঠানের মোবাইল" data-parsley-required minlength="11"  data-parsley-trigger=“keyup” value="{{ $nVisaEdit->nVisaAuthorizedPersonalOfTheOrg->auth_person_org_mobile }}" name="auth_person_org_mobile">
        </div>
        <div class="mb-3 col-lg-4">
