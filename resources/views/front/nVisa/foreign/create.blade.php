                    ...
                    <div class="card-body">
                        <div class="name_change_box">
                            ...
                            <div class="card mt-3 ">
                                ...
                                <div class="card-body">
                                    @include('front.nVisa.foreign.basicInfo')
                                </div>
                            </div>
                            <div class="card mt-3 ">
                                @include('front.nVisa.foreign.prticularOfSponsorEmployeer')
                            </div>
                            <div class="card mt-3 ">
                                @include('front.nVisa.foreign.prticularsOfForeignIncubment')

                            </div>
                            <div class="card mt-3 ">
                                @include('front.nVisa.foreign.employmentInformation')

                            </div>
                            <div class="card mt-3 ">
                                @include('front.nVisa.foreign.workPlaceAddress')
                            ...
                            <div class="card mt-3 ">
                                @include('front.nVisa.foreign.manPowerOfTheOffice')

                            </div>
                            <div class="card mt-3 ">

                                @include('front.nVisa.foreign.documentForWorkPermit')
                            ...
                            <div class="card mt-3 ">
                                ...
                                @include('front.nVisa.foreign.authorizedPersonOrganization')
