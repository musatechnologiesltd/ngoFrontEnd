    ...
    <div class="row">
        <div class="mb-3 col-lg-4">
            ...
            <input type="text" class="form-control" id=""
                   placeholder="বাড়ি/প্লট/হোল্ডিং/গ্রাম" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_house_no }}" name="work_house_no" required>
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">ফ্ল্যাট/অ্যাপার্টমেন্ট/ফ্লোর: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="ফ্ল্যাট/অ্যাপার্টমেন্ট/ফ্লোর" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_flat_no }}" name="work_flat_no" required>
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">রাস্তার নম্বর: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="রাস্তার নম্বর" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_road_no }}" name="work_road_no" required>
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">শহর/জেলা: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="শহর/জেলা" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_district }}" name="work_district" required>
        </div>
        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">থানা/উপজেলা: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
            placeholder="থানা/উপজেলা" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_thana }}" name="work_thana" required>
        </div>

        <div class="mb-3 col-lg-4">
            <label for="" class="form-label">ইমেইল: <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id=""
                   placeholder="ইমেইল" value="{{ $nVisaEdit->nVisaWorkPlaceAddress->work_email }}" required name="work_email">
        </div>
        <div class="mb-3 col-lg-4">
