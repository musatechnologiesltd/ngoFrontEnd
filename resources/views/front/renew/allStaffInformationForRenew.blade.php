...
@csrf
                <input type="hidden" class="form-control" value="{{ $getAllData1->id }}" name="fd_one_id"  id="">
...
<input type="hidden" class="form-control" value="{{ $allAllParti->id }}" name="id[]"  id="">
                        <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-12 mb-3">
                                ...
                                <input name="staff_name[]" readonly value="{{ $allAllParti->name }}" required type="text" class="form-control" id="">
                            </div>
                            <div class="col-lg-6 col-sm-12 mb-3">
                                <label for="" class="form-label">{{ trans('fd_one_step_three.desi')}} <span class="text-danger">*</span> </label>
                                <input name="staff_position[]" readonly value="{{ $allAllParti->position }}" required type="text" class="form-control" id="">
                            </div>
                            <div class="col-lg-6 col-sm-12 mb-3">
                                <label for="" class="form-label">{{ trans('fd_one_step_three.address')}} <span class="text-danger">*</span> </label>
                                <input name="staff_address[]" readonly value="{{ $allAllParti->address }}" required type="text" class="form-control" id="">
                            </div>
                            <div class="col-lg-6 col-sm-12 mb-3">
                                <label for="" class="form-label">{{ trans('fd_one_step_one.Mobile_Number')}} <span class="text-danger">*</span> </label>
                                <input name="staff_mobile[]"  value="{{ $allAllParti->mobile }}" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                type = "number"
                            ...
                            <div class="col-lg-6 col-sm-12 mb-3">
                                ...
                                <input name="staff_email[]"  value="{{ $allAllParti->email }}" required type="email" class="form-control" id="">
                            </div>
                            <div class="col-lg-6 col-sm-12 mb-3">
                                <label for="" class="form-label">{{ trans('fd_one_step_three.date_of_joining')}} <span class="text-danger">*</span> </label>
                                <input name="date_of_join[]" readonly  value="{{ date('d-m-Y', strtotime($allAllParti->date_of_join)) }}" required type="text" class="form-control datepicker" id="">
                            </div>

                            <?php
                            $convertNewAssCat  = explode(",",$allAllParti->citizenship);
                            ?>
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <input type="text" readonly required name="now_working_at[]" value="{{ $allAllParti->now_working_at }}" class="form-control" id="">
                            </div>
                            @else
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <input type="text" readonly required value="{{ $allAllParti->salary_statement }}" name="salary_statement[]" class="form-control" id="">
                            </div>
                            <div class="col-lg-12 mb-3">
                                <label for="" class="form-label">{{ trans('fd_one_step_three.detail')}} <span class="text-danger">*</span> </label>

                                <input type="text" readonly name="other_occupation[]" value="{{ $allAllParti->other_occupation }}" required class="form-control" id=""
