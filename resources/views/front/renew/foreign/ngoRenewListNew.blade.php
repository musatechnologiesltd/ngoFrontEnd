...
@if($getCountryType == 'Foreign')
            ...
            <div class="mb-3">
                ...
                <input type="text"  data-parsley-required name="nationality" value="{{ $getAllData1->nationality }}" class="form-control" id="">
            </div>
...
<div class="mb-3">
<label for="" class="form-label">{{ trans('mview.ttTwo')}}: <span class="text-danger">*</span></label>
<input type="text"   name="chief_name" value="{{ $getAllDataNewFirst->chief_name }}"   class="form-control" id="mainName" placeholder="{{ trans('mview.ttTwo')}}">
</div>

<div class="mb-3">
<label for="" class="form-label mt-3">{{ trans('mview.ttThree')}}: <span class="text-danger">*</span></label>
<input type="text"   name="chief_desi" value="{{ $getAllDataNewFirst->chief_desi }}" class="form-control"  placeholder="{{ trans('mview.ttThree')}}">
</div>
