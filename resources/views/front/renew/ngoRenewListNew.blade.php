...
$getAllData1 = DB::table('fd_one_forms')->where('user_id',Auth::user()->id)->first();
$queryToGetData = DB::table('countries')->where('id','!=',18)->orderBy('id','desc')->get();
$GetCityzenshipData = DB::table('countries')->whereNotNull('country_people_english')->whereNotNull('country_people_bangla')->orderBy('id','desc')->get();
$getCountryType = DB::table('ngo_type_and_languages')->where('user_id',Auth::user()->id)->value('ngo_type');
...
<div class="main active">
    ...
    <div class="mt-3">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" readonly value="{{ $getAllData1->organization_name }}" name="organization_name" data-parsley-required  id="">

                <input type="hidden" class="form-control" value="{{ $getAllData1->id }}" name="id"  id="">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">{{ trans('fd_one_step_one.Organization_address')}} <span class="text-danger">*</span> </label>
                <input type="text" class="form-control" readonly value="{{ $getAllData1->organization_address }}" name="organization_address" data-parsley-required  id="">
            </div>
            ...
            <div class="mb-3">
                <label for="" class="form-label">নিবন্ধন নম্বর <span class="text-danger">*</span> </label>
                <input type="text" class="form-control" readonly value="{{ $getAllData1->registration_number }}" name="reg_no_get_from_admin" data-parsley-required  id="">
            </div>
@endif
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" readonly value="{{ $getAllData1->address_of_head_office }}" name="address_of_head_office" data-parsley-required  id="">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" data-parsley-required value="{{ $getAllData1->org_phone }}"  name="phone_new" class="form-control" id="">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">মোবাইল নম্বর <span class="text-danger">*</span> </label>
                <input type="text" value="{{ $getAllData1->org_mobile }}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                type = "number"
            ...
            <div class="mb-3">
                ...
                <input type="email" value="{{ $getAllData1->org_email }}" data-parsley-required  name="email_new" class="form-control" id="">
            </div>

            <div class="mb-3">
                <label for=""  class="form-label">ওয়েবসাইট <span class="text-danger">*</span> </label>
                <input type="text" data-parsley-required value="{{ $getAllData1->web_site_name }}"  name="web_site_name" class="form-control" id="">
            </div>
...
@if($getCountryType == 'Foreign')
            ...
            <div class="mb-3">
                ...
                <input type="text" readonly data-parsley-required name="address" value="{{ $getAllData1->address }}" class="form-control" id="">
            </div>

            <div class="mb-3">
                <label for="" class="form-label">{{ trans('fd_one_step_one.nn')}} <span class="text-danger">*</span> </label>
                <input type="text" value="{{ $getAllData1->nationality }}"  data-parsley-required name="nationality" class="form-control" id="">
            </div>
            ...
            {{-- <div class="mb-3">
                ...
                <img src="{{asset('/')}}{{ $getAllData1->digital_signature }}" style="height:40px;"/>
            </div>
            ...
            <div class="mb-3">
                ...
                <img src="{{asset('/')}}{{ $getAllData1->digital_seal }}" style="height:40px;"/>
        ...
        <div class="mb-3">
            ...
            <input type="text"  data-parsley-required name="mobile" value="{{ $getAllData1->tele_phone_number }}"  class="form-control" id="">
        </div>
            ...
            <div class="mb-3">
                ...
                type = "number"
                maxlength = "11" readonly data-parsley-required minlength="11" name="phone" value="{{ $getAllData1->phone }}"  class="form-control" id="">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">{{ trans('fd_one_step_one.Email')}} <span class="text-danger">*</span> </label>
                <input type="text" readonly data-parsley-required name="email" value="{{ $getAllData1->email }}" class="form-control" id="">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">{{ trans('fd_one_step_one.Citizenship')}} <span class="text-danger">*</span> </label>

                    <?php
$convertNewAssCat  = explode(",",$getAllData1->citizenship);
$ngoType =  DB::table('ngo_type_and_languages')->where('user_id',Auth::user()->id)->value('ngo_type');
            ...
            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="yearly_budget" value="{{ $getAllData1->annual_budget }}" data-parsley-required class="form-control" id="">
                                </div>
...
$getAllDataNewFirst =DB::table('ngo_renew_infos')->where('user_id',Auth::user()->id)->latest()->first();
$mainNgoTypeRenew = DB::table('ngo_type_and_languages')->where('user_id',Auth::user()->id)->value('ngo_type_new_old');
$registrationNumberForOld = DB::table('ngo_type_and_languages')->where('user_id',Auth::user()->id)->value('registration');
...
<div class="main active">
    ...
    <div class="mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="hidden" class="form-control" value="{{ $getAllDataNewFirst->id }}" name="id"  id="">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">{{ trans('fd_one_step_one.Organization_address')}} <span class="text-danger">*</span> </label>
                <input type="text" class="form-control" readonly value="{{ $getAllData1->organization_address }}" name="organization_address" data-parsley-required  id="">
...
$getCountryType = DB::table('ngo_type_and_languages')->where('user_id',Auth::user()->id)->value('ngo_type');
    ...
    ?>
                                            ...
                                            <div class="mb-3">
                                                <label for="" class="form-label">টেলিফোন নম্বর <span class="text-danger">*</span> </label>
                                                <input type="text" data-parsley-required value="{{ $getAllDataNewFirst->phone_new }}"  name="phone_new" class="form-control" id="">
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">মোবাইল নম্বর <span class="text-danger">*</span> </label>
                                                <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                type = "number"
                                                maxlength = "11" minlength="11" data-parsley-required value="{{ $getAllDataNewFirst->mobile_new }}"  name="mobile_new" class="form-control" id="">
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">ইমেইল এড্রেস <span class="text-danger">*</span> </label>
                                                <input type="email" data-parsley-required value="{{ $getAllDataNewFirst->email_new }}"  name="email_new" class="form-control" id="">
                                            </div>

                                            <div class="mb-3">
                                                <label for=""  class="form-label">ওয়েবসাইট <span class="text-danger">*</span> </label>
                                                <input type="text" data-parsley-required value="{{ $getAllDataNewFirst->web_site_name }}"  name="web_site_name" class="form-control" id="">
                                            </div>
            ...
            <div class="mb-3">
                <label for="" class="form-label">{{ trans('fd_one_step_one.nn')}} <span class="text-danger">*</span> </label>
                <input type="text"  data-parsley-required name="nationality" value="{{ $getAllDataNewFirst->nationality }}" class="form-control" id="">
            </div>

            <div class="mb-3">
                <label for="" class="form-label">Telephone Number (টেলিফোন নম্বর) <span class="text-danger">*</span> </label>
                <input type="text"  data-parsley-required name="mobile" value="{{ $getAllDataNewFirst->mobile }}" class="form-control" id="">
            </div>
...
$ngoType =  DB::table('ngo_type_and_languages')->where('user_id',Auth::user()->id)->value('ngo_type');
            ...
            @if(empty($getAllDataNewFirst->foregin_pdf))
...
$filePath = url($getAllDataNewFirst->foregin_pdf);
...
<b>{{ $filename.'.'.$extension }}</b>
        ...
        @if(empty($getAllDataNewFirst->yearly_budget_file))
...
$filePath = url($getAllDataNewFirst->yearly_budget_file);
$filename  = pathinfo($filePath, PATHINFO_FILENAME);
...
<b>{{ $filename.'.'.$extension }}</b>
    ...
    <div class="mb-3">
    <label for="" class="form-label">{{ trans('mview.ttTwo')}}: <span class="text-danger">*</span></label>
         <input type="text" data-parsley-required  name="chief_name" value="{{ $getAllDataNewFirst->chief_name }}"  class="form-control" id="mainName" placeholder="{{ trans('mview.ttTwo')}}">
    </div>

    <div class="mb-3">
        <label for="" class="form-label mt-3">{{ trans('mview.ttThree')}}: <span class="text-danger">*</span></label>
        <input type="text" data-parsley-required value="{{ $getAllDataNewFirst->chief_desi }}"  name="chief_desi"  class="form-control"  placeholder="{{ trans('mview.ttThree')}}">
    </div>
    ...
    <div class="mb-3">
        ...
        <img src="{{asset('/')}}{{ $getAllDataNewFirst->digital_signature }}" style="height:40px;"/>
    </div>
    ...
    <div class="mb-3">
        ...
        <img src="{{asset('/')}}{{ $getAllDataNewFirst->digital_seal }}" style="height:40px;"/>
    </div>
    <!-- end new code -->
