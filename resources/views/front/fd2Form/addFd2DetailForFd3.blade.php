                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input type="text" required value="" name="ngo_prokolpo_start_date" class="form-control datepicker" id=""
                                                   placeholder="">
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="" class="form-label">সমাপ্তির তারিখ </label>
                                            <input type="text" required value="" name="ngo_prokolpo_end_date" class="form-control datepicker" id=""
                                                   placeholder="">
                                        </div>
                                    </div>
                                    <div class="row">
