                ...
                <div class="card">
                    <div class="card-body">
                        <div class="name_change_box">
                                ...
                                <div class="col-md-3 mt-2">
                                    <div class="card card-custom-color">
                                        <div class="card-body">
                                            ...
                                            <p><b>{{ $fd2OtherInfoAll->file_name }}:</b> <a target="_blank" href="{{ route('downloadFd2DetailForFc1',$fd2OtherInfoAll->id) }}" class="btn btn-custom next_button btn-sm" >
                            ...
                            <form method="post" action="{{ route('fd2ForFc1PdfUpdate') }}" enctype="multipart/form-data">
                            @csrf
