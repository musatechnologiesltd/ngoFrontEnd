...
if($newOldNgo != 'Old'){
$getRegId = DB::table('ngo_statuses')->where('fd_one_form_id',$getFormOneId)->value('status');
}else{

$getRegId = DB::table('ngo_renews')->where('fd_one_form_id',$getFormOneId)->value('status');
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if(empty($getDateLanOne))

                                                @else

                                                @if(session()->get('locale') == 'en')
                                                {{ App\Http\Controllers\NGO\CommonController::englishToBangla($getDateLanOne->format('d-m-Y')) }}

                                                @else

                                                {{ $getDateLanOne->format('d-m-Y') }}
...
<tr>
    <td>
        @if(empty($getDateFdOne))

        @else
        @if(session()->get('locale') == 'en')
        {{ App\Http\Controllers\NGO\CommonController::englishToBangla($getDateFdOne->format('d-m-Y')) }}

        @else

        {{ $getDateFdOne->format('d-m-Y') }}
...
@endif
    ...
    <td style="position:relative">
        ...
        @if($completeStatusFdOne == 'save_and_exit_from_three' || $completeStatusFdOne == 'next_step_from_three'  )
...
@endif
                                            ...
                                            <td style="position:relative">
                                                ...
                                                @if($completeStatusFdOne == 'save_and_exit_from_three')
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                @if(session()->get('locale') == 'en')
                                                {{ App\Http\Controllers\NGO\CommonController::englishToBangla($allRenewalData->created_at->format('d-m-Y')) }}

                                                @else

                                                {{ $allRenewalData->created_at->format('d-m-Y') }}
